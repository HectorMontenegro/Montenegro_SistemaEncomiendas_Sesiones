...
class EncomiendaForm(forms.ModelForm):
    """Formulario para registrar/editar encomiendas"""
    ...
    class Meta:
        ...
        widgets = {
            'codigo': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'ENC-2026-XXX'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Filtrar solo clientes y rutas activos
